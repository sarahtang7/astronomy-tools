...
def magAsteroid(filename, xCoorStar, yCoorStar, widthStar, magStar, xCoorAst, yCoorAst, widthAst, xCoorBlank, yCoorBlank):
    ...
    magAsteroid = -2.5*math.log10(signalAst) + constant
...
print("Magnitude of the Asteroid (first star): ", magAsteroid("sampleimage.fits", 173, 342, 5, 15.26, 351, 154, 3, 200, 200))
print("Magnitude of the Asteroid (second star): ", magAsteroid("sampleimage.fits", 355, 285, 5, 16.11, 351, 154, 3, 200, 200))
